            ...
            {category.items.map((item) => {
              ...
              return (
                <Button
                  ...
                  className="h-9 w-full justify-start gap-3 px-3 font-normal text-zinc-300 hover:bg-zinc-800 hover:text-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-zinc-100"
                >
