...
/** The `maxDuration` of src/app/api/cron/process-whatsapp-consents/route.ts, which runs this queue. */
 ...
 * recording its outcome and the database round trips around it.
 */
export const CONSENT_QUEUE_DEADLINE_MS = CONSENT_QUEUE_RUN_BUDGET_MS - MAX_SEND_TIMEOUT_MS - 5_000;
