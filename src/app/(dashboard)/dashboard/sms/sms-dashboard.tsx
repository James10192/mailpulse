  ...
  return (
    <div className="page-stack app-shell-safe">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <Button asChild variant="outline" className="gap-2"><Link href="/dashboard/campaigns"><Send className="size-4" />Voir les campagnes</Link></Button>
      </div>
          ...
          <CardContent>
            <form action={formAction} className="space-y-4">
              ...
              <div className="flex flex-col gap-3 border-t pt-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Button type="submit" disabled={pending || !content.trim()} className="gap-2"><MessageSquareText className="size-4" />{pending ? "Création..." : "Créer la campagne"}</Button>
              </div>
            </form>
          </CardContent>
        </Card>
