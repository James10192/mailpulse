      ...
      sections={[
        {
          ...
          content: (
            <div className="space-y-3">
              <p>
                Par défaut, vos emails sont envoyés depuis <strong className="text-zinc-200">onboarding@resend.dev</strong>, un domaine partagé. Vos emails risquent d&apos;arriver en spam car Gmail et les autres fournisseurs ne font pas confiance à ce domaine.
              </p>
              <p>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>Améliorez votre <strong className="text-zinc-200">délivrabilité</strong> (moins de spam)</li>
                <li>Renforcez votre <strong className="text-zinc-200">image de marque</strong> (emails de contact@votresite.com)</li>
                <li>Protégez votre <strong className="text-zinc-200">réputation</strong> d&apos;expéditeur</li>
        ...
        },
        {
          ...
          content: (
            <div className="space-y-3">
              <p>
                Vous pouvez utiliser votre domaine principal (<code className="text-orange-400">votresite.com</code>) ou un sous-domaine dédié (<code className="text-orange-400">mail.votresite.com</code> ou <code className="text-orange-400">newsletter.votresite.com</code>).
              </p>
        ...
        },
        {
          ...
          content: (
            <div className="space-y-3">
              <p>
                Après avoir ajouté votre domaine, MailPulse affiche des <strong className="text-zinc-200">enregistrements DNS</strong> (SPF et DKIM) à ajouter chez votre <strong className="text-zinc-200">registrar</strong> (là où vous avez acheté votre domaine).
              </p>
              ...
              <div className="rounded-lg bg-zinc-800/50 border border-zinc-700 p-3 space-y-2">
                ...
                <ul className="text-xs space-y-1">
                  ...
                  <li><strong className="text-zinc-200">DKIM</strong> (DomainKeys Identified Mail) : ajoute une signature cryptographique à vos emails pour prouver qu&apos;ils n&apos;ont pas été modifiés</li>
                </ul>
              </div>

              <p className="text-xs font-medium text-zinc-300">Où ajouter les DNS selon votre fournisseur :</p>
        ...
        },
        {
          ...
          content: (
            <div className="space-y-3">
              <p>
                Une fois les DNS configurés, revenez sur cette page et cliquez sur le bouton <strong className="text-zinc-200">Vérifier</strong> à côté de votre domaine. MailPulse va vérifier que les enregistrements sont corrects.
              </p>
              <div className="rounded-lg bg-zinc-800/50 border border-zinc-700 p-3 space-y-1">
                ...
                <p className="text-xs"><strong className="text-zinc-300">Vérification en cours (gris)</strong> : les DNS ne sont pas encore propagés, réessayez dans quelques minutes.</p>
                <p className="text-xs"><strong className="text-red-400">Échoué (rouge)</strong> : les enregistrements sont incorrects ou manquants, vérifiez vos DNS.</p>
              </div>
              <p>
                Si la vérification échoue après 48 h, vérifiez que vous avez copié les valeurs <strong className="text-zinc-200">exactement</strong> comme affichées (pas d&apos;espace en trop, pas de guillemets autour de la valeur TXT).
              </p>
            </div>
          ),
        },
        {
          ...
          content: (
            <div className="space-y-3">
              ...
              <div>
                <p className="text-xs font-medium text-zinc-300">Je peux envoyer sans domaine vérifié ?</p>
                <p className="text-xs mt-1">
                  Oui, mais uniquement depuis <code className="text-orange-400">onboarding@resend.dev</code>. Vos emails auront moins de chances d&apos;arriver en boîte de réception. C&apos;est acceptable pour tester, pas pour envoyer en production.
                </p>
              </div>
            </div>
          ),
