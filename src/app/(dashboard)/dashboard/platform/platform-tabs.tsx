...
export type PlatformTab = "messages" | "integrations";
 ...
 */
export function PlatformTabs({ tab, messages, integrations }: { tab: PlatformTab; messages: ReactNode; integrations: ReactNode }) {
